...
public class NumberConversion {
    public static void main(String[] args) {
        ...
        do {
            System.out.println(
                    "Enter a type of value to be generated or quit to exit the program (hex, binary, decimal, quit): ");
            ...
            switch (type) {
                case "hex":
                    ...
                    System.out.println("The binary equivalent of " + hexVal + " is " + resultBinary + " or "
                            + stripLeadZeros(resultBinary));
                    System.out.println("-------------------------------------------------------------------------");
                    break;
                case "binary":
                ...
                case "decimal":
                    ...
                    System.out.println("-------------------------------------------------------------------------");
                    System.out.println("The binary equivalent of " + randomNum + " is " + resultBinary + " or "
                            + stripLeadZeros(resultBinary));
    ...
    public static String convertDecToBinary(int input) {
        String resultStr = "";
        for (int i = 0; i < 8; i++) {
            int x = (input & 0xF0000000);
            input <<= 4;
            if(x == 0) continue;
            else {
                for(int j = 0; j < 4; j++) {
                    resultStr += (x & 0x80000000) >>> 31;
                    x <<= 1;
                }
            }
        }
